...
export function DashboardQuickActions() {
  ...
  const actions = [
    ...
    { label: 'Personel', icon: UserCheck, onClick: () => navigate('/personel'), color: 'text-accent bg-accent/8 hover:bg-accent/15 border-accent/15' },
    ...
    { label: 'Ödemeler', icon: CreditCard, onClick: () => navigate('/odemeler'), color: 'text-info bg-info/8 hover:bg-info/15 border-info/15' },
    ...
    { label: 'Satış', icon: ShoppingBag, onClick: () => navigate('/musteriler'), color: 'text-success bg-success/8 hover:bg-success/15 border-success/15' },
    { label: 'Kasa', icon: Wallet, onClick: () => navigate('/kasa'), color: 'text-warning bg-warning/8 hover:bg-warning/15 border-warning/15' },
